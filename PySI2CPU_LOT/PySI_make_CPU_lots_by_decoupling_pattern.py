#@240127 共通ロット生成　座標マスタ　ID=lot_id+plan_YYYY_WWでユニークに
    ...
    def extract_CPU(self, csv_writer):
        ...
        for w in range(1, plan_len):  
            ...
            for step_no, lot_id in enumerate(s):
                ...
                CPU_row = [ w, lot_id_yyyyww, "s", self.name, self.longtude, self.latitude, step_no, self.lot_size]
            ...
            for step_no, lot_id in enumerate(i1):
                ...
                CPU_row = [ w, lot_id_yyyyww, "i1", self.name, self.longtude, self.latitude, step_no, self.lot_size]
            ...
            for step_no, lot_id in enumerate(p):
                ...
                CPU_row = [ w, lot_id_yyyyww, "p", self.name, self.longtude, self.latitude, step_no, self.lot_size]
    ...
    with open(csv_file, newline="", encoding="utf-8") as f:
        ...
        for row in reader:
            ...
            if row[0] == "root":
                ...
                #@240128
                root = nodes[row[1]]
                root.set_attributes(row)  # rootノードにアプリ属性セット
                ...
                child.set_attributes(row)  # 子ノードにアプリ属性セット
...
def main():
    ...
    # DataFrameを辞書に変換する
    node_position_dic = df.set_index('node_name')[['longtude', 'latitude']].T.to_dict('list')
   ...
   #print("year_list", year_list)
    ...
    for i, nodes_decouple in enumerate(nodes_decouple_all):
        ...
        #@240203
        # **************************************
        # make_CPU_lots_by_decoupling_pattern
        # **************************************
        ...
        filename = "CPU_OUT_FW_plan" + str(i) + ".csv"
        print('filename',filename)
        print('nodes_decouple',nodes_decouple)
